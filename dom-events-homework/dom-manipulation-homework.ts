...
const hOne: HTMLElement = document.getElementsByTagName("h1")[0];
hOne.textContent = "Updated Text";

// 2.Change the color of the paragraph inside div.content.
const divP = document.querySelector(".content p") as HTMLElement;
divP.style.color = "#0099FF";

// 3.Change the list items textContent for example to be list of fruits.
const list1: NodeListOf<Element> = document.querySelectorAll("#list li");
